...
'site.tax_ratio'=>array('class'=>'trigger_tax','type'=>SET_T_STR,'default'=>'0.05','desc'=>app::get('b2c')->_('税率'),'helpinfo'=>'<span class=\'notice-inline\'>'.app::get('b2c')->_('例：税率为5%请填写0.05，留空则前台不显示税率信息。').'</span>','javascript'=>'$$("input[name^=set[site.tax_ratio]]").addEvent("change",function(e){var _target=$(e.target)||$(e);if (_target.value == "" || _target.value == "0") _target.value = "";});','vtype'=>'number'),
'site.trigger_tax'=>array('id'=>'trigger_tax','type'=>SET_T_BOOL,'default'=>'false','desc'=>app::get('b2c')->_('是否设置含税价格'),'javascript'=>'if(document.getElement("[name=\"set[site.trigger_tax]\"]:checked").value == "false") $$(".trigger_tax").getParent("tr").hide();'),//WZP
